!function (n) {
  ...
  function w(t) {
    if (!qt.__browser) {
      ...
      var n = P("<div/>").css({
        ...
        width: 100,
        overflow: "scroll"
      }).append(P("<div/>").css({width: "100%", height: 10}))).appendTo("body"), a = n.children(), r = a.children();
  ...
  function C(t, e) {
    var n = qt.defaults.column, a = t.aoColumns.length;
  ...
  function x(t, e, n) {
    ...
    n !== j && null !== n && (T(n), D(qt.defaults.column, n), n.mDataProp !== j && !n.mData && (n.mData = n.mDataProp), n.sType && (e._sManualType = n.sType), n.className && !n.sClass && (n.sClass = n.className), n.sClass && r.addClass(n.sClass), P.extend(e, n), Pt(e, n, "sWidth", "sWidthOrig"), n.iDataSort !== j && (e.aDataSort = [n.iDataSort]), Pt(e, n, "aDataSort"));
  ...
  function i(t) {
    var e, n, a, r, o, i, l, s, u, c = t.aoColumns, f = t.aoData, d = qt.ext.type.detect;
  ...
  function F(t, e, n, a) {
    var r = t.aoData.length, o = P.extend(!0, {}, qt.models.oRow, {src: n ? "dom" : "data", idx: r});
  ...
  function s(t, e, n, a) {
    var r, o, i, l = [], s = e.firstChild, u = 0, c = t.aoColumns, f = t._rowReadObject,
      d = (a = a !== j ? a : f ? {} : [], function (t, e) {
        if ("string" == typeof t) {
          var n = t.indexOf("@");
          -1 !== n && (n = t.substring(n + 1), p(t)(a, e.getAttribute(n)))
        }
      }), h = function (t) {
        n !== j && n !== u || (o = c[u], i = P.trim(t.innerHTML), o && o._bAttrSrc ? (p(o.mData._)(a, i), d(o.mData.sort, t), d(o.mData.type, t), d(o.mData.filter, t)) : f ? (o._setter || (o._setter = p(o.mData)), o._setter(a, i)) : a[u] = i), u++
      };
    if (s) for (; s;) "TD" != (r = s.nodeName.toUpperCase()) && "TH" != r || (h(s), l.push(s)), s = s.nextSibling; else for (s = 0, r = (l = e.anCells).length; s < r; s++) h(l[s]);
    return (e = e.firstChild ? e : e.nTr) && (e = e.getAttribute("id")) && p(t.rowId)(a, e), {data: a, cells: l}
  }

  function g(t, e, n, a) {
    var r, o, i, l, s, u = t.aoData[e], c = u._aData, f = [];
    if (null === u.nTr) {
      for (r = n || S.createElement("tr"), u.nTr = r, u.anCells = f, r._DT_RowIndex = e, d(t, u), l = 0, s = t.aoColumns.length; l < s; l++) i = t.aoColumns[l], (o = n ? a[l] : S.createElement(i.sCellType))._DT_CellIndex = {
        row: e,
        column: l
  ...
  function b(t) {
    ...
    for (s && (r = P("<tr/>").appendTo(i)), e = 0, n = c.length; e < n; e++) o = c[e], a = P(o.nTh).addClass(o.sClass), s && a.appendTo(r), t.oFeatures.bSort && (a.addClass(o.sSortingClass), !1 !== o.bSortable && (a.attr("tabindex", t.iTabIndex).attr("aria-controls", t.sTableId), Ct(t, o.nTh, e))), o.sTitle != a[0].innerHTML && a.html(o.sTitle), Mt(t, "header")(t, a, o, u);
  ...
  function M(t) {
    ...
    if (-1 !== P.inArray(!1, e)) dt(t, !1); else {
      e = [];
      var n = 0, a = t.asStripeClasses, r = a.length, o = t.oLanguage, i = t.iInitDisplayStart, l = "ssp" == Wt(t),
        s = t.aiDisplay;
      ...
      if (0 !== s.length) for (o = l ? t.aoData.length : u, l = l ? 0 : i; l < o; l++) {
        ...
        if (null === f.nTr && g(t, c), c = f.nTr, 0 !== r) {
          var d = a[n % r];
          f._sRowStripe != d && (P(c).removeClass(f._sRowStripe).addClass(d), f._sRowStripe = d)
        }
        kt(t, "aoRowCallback", null, [c, f._aData, n, l]), e.push(c), n++
      ...
      kt(t, "aoHeaderCallback", "header", [P(t.nTHead).children("tr")[0], h(t), i, u, s]), kt(t, "aoFooterCallback", "footer", [P(t.nTFoot).children("tr")[0], h(t), i, u, s]), (a = P(t.nTBody)).children().detach(), a.append(P(e)), kt(t, "aoDrawCallback", "draw", [t]), t.bSorted = !1, t.bFiltered = !1, t.bDrawing = !1
    }
  }
  ...
  function E(t) {
    ...
    for (var o, i, l, s, u, c, f = t.sDom.split(""), d = 0; d < f.length; d++) {
      if (o = null, "<" == (i = f[d])) {
        ...
        r.append(l), r = P(l)
      } else if (">" == i) r = r.parent(); else if ("l" == i && a.bPaginate && a.bLengthChange) o = st(t); else if ("f" == i && a.bFilter) o = G(t); else if ("r" == i && a.bProcessing) o = ft(t); else if ("t" == i) o = ht(t); else if ("i" == i && a.bInfo) o = nt(t); else if ("p" == i && a.bPaginate) o = ut(t); else if (0 !== qt.ext.feature.length) for (c = 0, s = (l = qt.ext.feature).length; c < s; c++) if (i == l[c].cFeature) {
        o = l[c].fnInit(t);
        break
      }
  ...
  function V(a, t, e) {
    ...
    var n, i = a.ajax, l = a.oInstance, s = function (t) {
    ...
    }, a.oAjaxData = t, kt(a, null, "preXhr", [a, t]), a.fnServerData ? a.fnServerData.call(l, a.sAjaxSource, P.map(t, function (t, e) {
      return {name: e, value: t}
    }), s, a) : a.sAjaxSource || "string" == typeof i ? a.jqXHR = P.ajax(P.extend(u, {url: i || a.sAjaxSource})) : P.isFunction(i) ? a.jqXHR = i.call(l, t, s, a) : (a.jqXHR = P.ajax(P.extend(u, i)), i.data = n)
  }
  ...
  function t(t) {
    ...
    d("sEcho", t.iDraw), d("iColumns", i), d("sColumns", re(o, "sName").join(",")), d("iDisplayStart", e), d("iDisplayLength", n);
    var h = {draw: t.iDraw, columns: [], order: [], start: e, length: n, search: {value: s.sSearch, regex: s.bRegex}};
    ...
    }), d("iSortingCols", f.length)), null === (o = qt.ext.legacy.ajax) ? t.sAjaxSource ? c : h : o ? c : h
  }

  function J(t, e) {
    var n = q(t, e), a = e.sEcho !== j ? e.sEcho : e.draw, r = e.iTotalRecords !== j ? e.iTotalRecords : e.recordsTotal,
  ...
  function $(t, e, n) {
    ...
    if (i(t), "ssp" != Wt(t)) {
      for (Z(t, e.sSearch, n, e.bEscapeRegex !== j ? !e.bEscapeRegex : e.bRegex, e.bSmart, e.bCaseInsensitive), o(e), e = 0; e < r.length; e++) Y(t, r[e].sSearch, e, r[e].bEscapeRegex !== j ? !r[e].bEscapeRegex : r[e].bRegex, r[e].bSmart, r[e].bCaseInsensitive);
      z(t)
    } else o(e);
  ...
  function Y(t, e, n, a, r, o) {
    if ("" !== e) {
      var i = [], l = t.aiDisplay;
      for (a = Q(e, a, r, o), r = 0; r < l.length; r++) e = t.aoData[l[r]]._aFilterData[n], a.test(e) && i.push(l[r]);
      t.aiDisplay = i
    }
  }
  ...
  function Z(t, e, n, a, r, o) {
    ...
    r = [];
    if (0 !== qt.ext.search.length && (n = !0), i = K(t), e.length <= 0) t.aiDisplay = l.slice(); else {
  ...
  function ot(n) {
    ...
    if (n.bInitialised) {
      for (E(n), b(n), O(n, n.aoHeader), O(n, n.aoFooter), dt(n, !0), t.bAutoWidth && bt(n), a = 0, t = o.length; a < t; a++) (e = o[a]).sWidth && (e.nTh.style.width = Dt(e.sWidth));
  ...
  function ut(t) {
    var e = t.sPaginationType, i = qt.ext.pager[e], l = "function" == typeof i, s = function (t) {
      M(t)
    }, u = (e = P("<div/>").addClass(t.oClasses.sPaging + e)[0], t.aanFeatures);
    return l || i.fnInit(t, e, s), u.p || (e.id = t.sTableId + "_paginate", t.aoDrawCallback.push({
      fn: function (t) {
        if (l) {
  ...
  function ct(t, e, n) {
    ...
    return 0 === o || -1 === r ? a = 0 : "number" == typeof e ? o < (a = e * r) && (a = 0) : "first" == e ? a = 0 : "previous" == e ? (a = 0 <= r ? a - r : 0) < 0 && (a = 0) : "next" == e ? a + r < o && (a += r) : "last" == e ? a = Math.floor((o - 1) / r) * r : Rt(t, 0, "Unknown paging action: " + e, 5), e = t._iDisplayStart !== a, t._iDisplayStart = a, e && (kt(t, null, "page", [t]), n && M(t)), e
  }
  ...
  function pt(n) {
    var t, e, a, r, o, i = (u = n.oScroll).sX, l = u.sXInner, s = u.sY, u = u.iBarWidth, c = P(n.nScrollHead),
      f = c[0].style, d = (p = c.children("div"))[0].style, h = p.children("table"), p = n.nScrollBody, g = P(p),
      b = p.style, m = P(n.nScrollFoot).children("div"), S = m.children("table"), v = P(n.nTHead), D = P(n.nTable),
      y = D[0], _ = y.style, T = n.nTFoot ? P(n.nTFoot) : null, w = n.oBrowser, C = w.bScrollOversize,
      x = re(n.aoColumns, "nTh"), I = [], A = [], F = [], L = [], R = function (t) {
        (t = t.style).paddingTop = "0", t.paddingBottom = "0", t.borderTopWidth = "0", t.borderBottomWidth = "0", t.height = 0
      };
    e = p.scrollHeight > p.clientHeight, n.scrollBarVis !== e && n.scrollBarVis !== j ? (n.scrollBarVis = e, H(n)) : (n.scrollBarVis = e, D.children("thead, tfoot").remove(), T && (a = T.clone().prependTo(D), t = T.find("tr"), a = a.find("tr")), r = v.clone().prependTo(D), v = v.find("tr"), e = r.find("tr"), r.find("th, td").removeAttr("tabindex"), i || (b.width = "100%", c[0].style.width = "100%"), P.each(U(n, r), function (t, e) {
      o = N(n, t), e.style.width = n.aoColumns[o].sWidth
    }), T && gt(function (t) {
      t.style.width = ""
    }, a), c = D.outerWidth(), "" === i ? (_.width = "100%", C && (D.find("tbody").height() > p.offsetHeight || "scroll" == g.css("overflow-y")) && (_.width = Dt(D.outerWidth() - u)), c = D.outerWidth()) : "" !== l && (_.width = Dt(l), c = D.outerWidth()), gt(R, e), gt(function (t) {
      F.push(t.innerHTML), I.push(Dt(P(t).css("width")))
    }, e), gt(function (t, e) {
      -1 !== P.inArray(t, x) && (t.style.width = I[e])
    }, v), P(e).height(0), T && (gt(R, a), gt(function (t) {
      L.push(t.innerHTML), A.push(Dt(P(t).css("width")))
    }, a), gt(function (t, e) {
      t.style.width = A[e]
    }, t), P(a).height(0)), gt(function (t, e) {
      t.innerHTML = '<div class="dataTables_sizing" style="height:0;overflow:hidden;">' + F[e] + "</div>", t.style.width = I[e]
    }, e), T && gt(function (t, e) {
      t.innerHTML = '<div class="dataTables_sizing" style="height:0;overflow:hidden;">' + L[e] + "</div>", t.style.width = A[e]
    }, a), D.outerWidth() < c ? (t = p.scrollHeight > p.offsetHeight || "scroll" == g.css("overflow-y") ? c + u : c, C && (p.scrollHeight > p.offsetHeight || "scroll" == g.css("overflow-y")) && (_.width = Dt(t - u)), ("" === i || "" !== l) && Rt(n, 1, "Possible column misalignment", 6)) : t = "100%", b.width = Dt(t), f.width = Dt(t), T && (n.nScrollFoot.style.width = Dt(t)), !s && C && (b.height = Dt(y.offsetHeight + u)), i = D.outerWidth(), h[0].style.width = Dt(i), d.width = Dt(i), l = D.height() > p.clientHeight || "scroll" == g.css("overflow-y"), d[s = "padding" + (w.bScrollbarLeft ? "Left" : "Right")] = l ? u + "px" : "0px", T && (S[0].style.width = Dt(i), m[0].style.width = Dt(i), m[0].style[s] = l ? u + "px" : "0px"), D.children("colgroup").insertBefore(D.children("thead")), g.scroll(), !n.bSorted && !n.bFiltered || n._drawHold || (p.scrollTop = 0))
  }
  ...
  function bt(t) {
    ...
    if (g || !h && !i && !o && s == v(t) && s == c.length) for (e = 0; e < s; e++) null !== (u = N(t, e)) && (r[u].sWidth = Dt(c.eq(e).width())); else {
  ...
  function mt(t, e) {
    if (!t) return 0;
    var n = P("<div/>").css("width", Dt(t)).appendTo(e || S.body), a = n[0].offsetWidth;
    return n.remove(), a
  }
  ...
  function _t(t) {
    var e, n, a, u, c = [], f = qt.ext.type.order, d = t.aoData, r = 0, o = t.aiDisplayMaster;
  ...
  function wt(t, e, n, a) {
    var r = t.aaSorting, o = t.aoColumns[e].asSorting, i = function (t, e) {
      var n = t._idx;
  ...
  function xt(t) {
    ...
    if (i.bSort && i.bSortClasses) {
      for (i = 0, e = a.length; i < e; i++) n = a[i].src, P(re(t.aoData, "anCells", n)).removeClass(r + (i < 2 ? i + 1 : 3));
      for (i = 0, e = o.length; i < e; i++) n = o[i].src, P(re(t.aoData, "anCells", n)).addClass(r + (i < 2 ? i + 1 : 3))
    }
    t.aLastSort = o
  }
  ...
  function It(t, e) {
    ...
    for (var o, i = qt.ext.type.order[a.sType + "-pre"], l = 0, s = t.aoData.length; l < s; l++) (a = t.aoData[l])._aSortData || (a._aSortData = []), (!a._aSortData[e] || r) && (o = r ? n[l] : R(t, l, e, "sort"), a._aSortData[e] = i ? i(o) : o)
  }
  ...
  function Rt(t, e, n, a) {
    if (n = "DataTables warning: " + (t ? "table id=" + t.sTableId + " - " : "") + n, a && (n += ". For more information about this error, please see http://datatables.net/tn/" + a), e) m.console && console.log && console.log(n); else if (e = (e = qt.ext).sErrMode || e.errMode, t && kt(t, null, "error", [t, a, n]), "alert" == e) alert(n); else {
  ...
  function Mt(t, e) {
    var n = t.renderer, a = qt.ext.renderer[e];
  ...
  function Et(t, e) {
    ...
    return e <= n ? n = ie(0, e) : t <= a ? ((n = ie(0, n - 2)).push("ellipsis"), n.push(e - 1)) : (e - 1 - a <= t ? n = ie(e - (n - 2), e) : ((n = ie(t - a + 2, t + a - 1)).push("ellipsis"), n.push(e - 1)), n.splice(0, 0, "ellipsis"), n.splice(0, 0, 0)), n.DT_el = "span", n
  }
  ...
  var Ut, Vt, Xt, Jt, qt = function (b) {
      ...
      for (var t in S && (b = {}), this.oApi = this.internal = Ut.internal, qt.ext.internal) t && (this[t] = e(t));
      return this.each(function () {
        var n, t = {}, a = 1 < v ? jt(t, b, !0) : b, r = 0, o = (t = this.getAttribute("id"), !1), e = qt.defaults,
          i = P(this);
        if ("table" != this.nodeName.toLowerCase()) Rt(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2); else {
          ...
          t = function () {
            ...
            xt(c), g.bSort && Nt(c, "aoDrawCallback", function () {
              if (c.bSorted) {
                var t = yt(c), n = {};
                P.each(t, function (t, e) {
                  n[e.src] = e.dir
          ...
          a.bStateSave ? (g.bStateSave = !0, Nt(c, "aoDrawCallback", At, "state_save"), Ft(c, a, t)) : t()
        }
      }), m = null, this
    }, Gt = {}, $t = /[\r\n]/g, zt = /<.*?>/g,
    Yt = /^\d{2,4}[\.\/\-]\d{1,2}[\.\/\-]\d{1,2}([T ]{1}\d{1,2}[:\.]\d{2}([\.:]\d{2})?)?$/,
    Zt = RegExp("(\\/|\\.|\\*|\\+|\\?|\\||\\(|\\)|\\[|\\]|\\{|\\}|\\\\|\\$|\\^|\\-)", "g"),
    Qt = /[',$£€¥%\u2009\u202F\u20BD\u20a9\u20BArfk]/gi, Kt = function (t) {
      return !t || !0 === t || "-" === t
    }, te = function (t) {
      var e = parseInt(t, 10);
      ...
      return !!Kt(t) || (e && a && (t = ee(t, e)), n && a && (t = t.replace(Qt, "")), !isNaN(parseFloat(t)) && isFinite(t))
    }, ae = function (t, e, n) {
      return !!Kt(t) || ((Kt(t) || "string" == typeof t) && !!ne(t.replace(zt, ""), e, n) || null)
    }, re = function (t, e, n) {
  ...
  var ue = function (t, e, n) {
      t[e] !== j && (t[n] = t[e])
    }, ce = /\[.*?\]$/, fe = /\(\)$/, de = qt.util.escapeRegex, he = P("<div>")[0], pe = he.textContent !== j,
    ge = /<.*?>/g, be = qt.util.throttle, me = [], Se = Array.prototype;
  Vt = function (t, e) {
    ...
    if (P.isArray(t)) for (var a = 0, r = t.length; a < r; a++) n(t[a]); else n(t);
    this.context = se(i), e && P.merge(this, e), this.selector = {
      rows: null,
      cols: null,
      opts: null
    }, Vt.extend(this, this, me)
  }, qt.Api = Vt, P.extend(Vt.prototype, {
    any: function () {
      return 0 !== this.count()
    }, concat: Se.concat, context: [], count: function () {
    ...
    }, join: Se.join, indexOf: Se.indexOf || function (t, e) {
      ...
      return f.length || a ? ((e = (t = new Vt(d, t ? f.concat.apply([], f) : f)).selector).rows = h.rows, e.cols = h.cols, e.opts = h.opts, t) : this
    ...
    }, pop: Se.pop, push: Se.push, reduce: Se.reduce || function (t, e) {
      return n(this, t, e, 0, this.length, 1)
    }, reduceRight: Se.reduceRight || function (t, e) {
      return n(this, t, e, this.length - 1, -1, -1)
    }, reverse: Se.reverse, selector: null, shift: Se.shift, slice: function () {
      return new Vt(this.context, this)
    }, sort: Se.sort, splice: Se.splice, toArray: function () {
    ...
    if (n.length && e && (e instanceof Vt || e.__dt_wrapper)) {
      ...
      for (a = 0, r = n.length; a < r; a++) e[(o = n[a]).name] = "function" == typeof o.val ? i(t, o.val, o) : P.isPlainObject(o.val) ? {} : o.val, e[o.name].__dt_wrapper = !0, Vt.extend(t, e[o.name], o.propExt)
    }
  }, Vt.register = Xt = function (t, e) {
    if (P.isArray(t)) for (var n = 0, a = t.length; n < a; n++) Vt.register(t[n], e); else {
    ...
    Vt.register(t, n), Vt.register(e, function () {
      var t = n.apply(this, arguments);
      return t === this ? this : t instanceof Vt ? t.length ? P.isArray(t[0]) ? new Vt(t.context, t[0]) : t[0] : j : t
    })
  ...
  var De = function (t, e, n, a, r) {
    ...
    if ((t = Ut.selector[t]).length) for (l = 0, s = t.length; l < s; l++) f = t[l](a, r, f);
    return se(f)
  }, ye = function (t) {
    ...
    n = t.aiDisplayMaster;
    var l = e.search;
    if (a = e.order, r = e.page, "ssp" == Wt(t)) return "removed" === l ? [] : ie(0, n.length);
    if ("current" == r) for (n = t._iDisplayStart, a = t.fnDisplayEnd(); n < a; n++) o.push(i[n]); else if ("current" == a || "applied" == a) o = "none" == l ? n.slice() : "applied" == l ? i.slice() : P.map(n, function (t) {
      return -1 === P.inArray(t, i) ? t : null
    }); else if ("index" == a || "original" == a) for (n = 0, a = t.aoData.length; n < a; n++) "none" == l ? o.push(n) : (-1 === (r = P.inArray(n, i)) && "removed" == l || 0 <= r && "applied" == l) && o.push(n);
    return o
  };
  Xt("rows()", function (t, e) {
    ...
    var n = this.iterator("table", function (a) {
      ...
      return De("row", t, function (n) {
        ...
        if (r || (r = Te(a, o)), null !== t && -1 !== P.inArray(t, r)) return [t];
        if (null === n || n === j || "" === n) return r;
        if ("function" == typeof n) return P.map(r, function (t) {
          var e = a.aoData[t];
          return n(t, e._aData, e.nTr) ? t : null
        });
        if (t = le(oe(a.aoData, r, "nTr")), n.nodeName) return n._DT_RowIndex !== j ? [n._DT_RowIndex] : n._DT_CellIndex ? [n._DT_CellIndex.row] : (t = P(n).closest("*[data-dt-row]")).length ? [t.data("dt-row")] : [];
    ...
    return this.iterator("row", function (t, e, n) {
      ...
      f(t.aiDisplayMaster, e), f(t.aiDisplay, e), f(c[n], e, !1), 0 < t._iRecordsDisplay && t._iRecordsDisplay--, Ot(t), (e = t.rowIdFn(u._aData)) !== j && delete t.aIds[e]
  ...
  var we = function (t, e) {
    ...
    if (n.length && t.length) {
      ...
      if (a._details) {
        ...
        var i = n[0], r = new Vt(i), l = i.aoData;
        r.off("draw.dt.DT_details column-visibility.dt.DT_details destroy.dt.DT_details"), 0 < re(l, "_details").length && (r.on("draw.dt.DT_details", function (t, e) {
  ...
  Xt("columns()", function (e, n) {
    ...
    var t = this.iterator("table", function (o) {
      var t = e, i = n, l = o.aoColumns, s = re(l, "sName"), u = re(l, "nTh");
    ...
    return this.iterator("column-rows", function (t, e, n, a, r) {
      return oe(t.aoData, r, "search" === o ? "_aFilterData" : "_aSortData", e)
    }, 1)
    ...
    if (P.isPlainObject(g) && (g.row === j ? (b = g, g = null) : (b = t, t = null)), P.isPlainObject(t) && (b = t, t = null), null === t || t === j) return this.iterator("table", function (n) {
      var a, r, o, i, l, s, u, t = g, e = ye(b), c = n.aoData, f = Te(n, e), d = le(oe(c, f, "anCells")),
    ...
    var n, a, r, o, i, l = this.columns(t, b), s = this.rows(g, b), e = this.iterator("table", function (t, e) {
    ...
    var r = P(t).get(0), o = !1;
    return t instanceof qt.Api || (P.each(qt.settings, function (t, e) {
    ...
    return t ? new Vt(n) : n
  }, qt.camelToHungarian = D, Xt("$()", function (t, e) {
    ...
    return f = f || !1, this.iterator("table", function (e) {
      var n, t = e.nTableWrapper.parentNode, a = e.oClasses, r = e.nTable, o = e.nTBody, i = e.nTHead, l = e.nTFoot,
        s = P(r), u = (o = P(o), P(e.nTableWrapper)), c = P.map(e.aoData, function (t) {
          return t.nTr
        });
    ...
    return (t = k(t)(a.oLanguage)) === j && (t = e), n !== j && P.isPlainObject(t) && (t = t[n] !== j ? t[n] : t._), t.replace("%d", n)
    ...
    fnDisplayEnd: function () {
      var t = this._iDisplayLength, e = this._iDisplayStart, n = e + t, a = this.aiDisplay.length, r = this.oFeatures,
        o = r.bPaginate;
  ...
  P.extend(Ae, {
      ...
      _: function (l, t, s, e, u, c) {
        var f, d, n, h = l.oClasses, p = l.oLanguage.oPaginate, g = l.oLanguage.oAria.paginate || {}, b = 0,
          m = function (t, e) {
            ...
            for (n = 0, a = e.length; n < a; n++) if (o = e[n], P.isArray(o)) r = P("<" + (o.DT_el || "div") + "/>").appendTo(t), m(r, o); else {
              switch (f = null, d = "", o) {
                case"ellipsis":
                  t.append('<span class="ellipsis">&#x2026;</span>');
                  break;
                case"first":
                  f = p.sFirst, d = o + (0 < u ? "" : " " + h.sPageButtonDisabled);
                  break;
                case"previous":
                  f = p.sPrevious, d = o + (0 < u ? "" : " " + h.sPageButtonDisabled);
                  break;
                case"next":
                  f = p.sNext, d = o + (u < c - 1 ? "" : " " + h.sPageButtonDisabled);
                  break;
                case"last":
                  f = p.sLast, d = o + (u < c - 1 ? "" : " " + h.sPageButtonDisabled);
                  break;
                default:
                  f = o + 1, d = u === o ? h.sPageButtonActive : ""
              }
              null !== f && (Ht(r = P("<a>", {
                ...
                id: 0 === s && "string" == typeof o ? l.sTableId + "_" + o : null
              }).html(f).appendTo(t), {action: o}, i), b++)
            }
          };
        try {
        ...
        m(P(t).empty(), e), n !== j && P(t).find("[data-dt-idx=" + n + "]").focus()
      }
    }
    ...
    return Kt(t) || "string" == typeof t && -1 !== t.indexOf("<") ? "html" : null
  }]), P.extend(qt.ext.type.search, {
    html: function (t) {
      return Kt(t) ? t : "string" == typeof t ? t.replace($t, " ").replace(zt, "") : ""
    }, string: function (t) {
      return Kt(t) ? t : "string" == typeof t ? t.replace($t, " ") : t
    }
  });
  ...
  P.extend(Ut.type.order, {
    "date-pre": function (t) {
      ...
      return Kt(t) ? "" : t.replace ? t.replace(/<.*?>/g, "").toLowerCase() : t + ""
    }, "string-pre": function (t) {
      return Kt(t) ? "" : "string" == typeof t ? t.toLowerCase() : t.toString ? t.toString() : ""
  ...
  return v.extend(!0, o.defaults, {
    ...
    var f, d, n, h = new o.Api(l), p = l.oClasses, g = l.oLanguage.oPaginate, b = l.oLanguage.oAria.paginate || {},
      m = 0, S = function (t, e) {
        var n, a, r, o, i = function (t) {
          t.preventDefault(), !v(t.currentTarget).hasClass("disabled") && h.page() != t.data.action && h.page(t.data.action).draw("page")
        };
        for (n = 0, a = e.length; n < a; n++) if (o = e[n], v.isArray(o)) S(t, o); else {
          switch (d = f = "", o) {
            case"ellipsis":
              f = "&#x2026;", d = "disabled";
              break;
            case"first":
              f = g.sFirst, d = o + (0 < u ? "" : " disabled");
              break;
            case"previous":
              f = g.sPrevious, d = o + (0 < u ? "" : " disabled");
              break;
            case"next":
              f = g.sNext, d = o + (u < c - 1 ? "" : " disabled");
              break;
            case"last":
              f = g.sLast, d = o + (u < c - 1 ? "" : " disabled");
              break;
            default:
              f = o + 1, d = u === o ? "active" : ""
          }
          f && (r = v("<li>", {
            ...
            tabindex: l.iTabIndex,
            class: "page-link"
          }).html(f)).appendTo(t), l.oApi._fnBindAction(r, {action: o}, i), m++)
        }
      };
    try {
