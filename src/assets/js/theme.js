...
!function (e, t) {
  ...
  !function (T) {
    "use strict";
    var r, e, l, t, i, d, n;
    String.prototype.includes || (r = {}.toString, e = function () {
      try {
        var e = {}, t = Object.defineProperty, i = t(e, e, e) && t
      } catch (e) {
      }
      return i
    }(), l = "".indexOf, t = function (e) {
      if (null == this) throw new TypeError;
      var t = String(this);
      if (e && "[object RegExp]" == r.call(e)) throw new TypeError;
      var i = t.length, n = String(e), s = n.length, o = 1 < arguments.length ? arguments[1] : void 0,
        a = o ? Number(o) : 0;
    ...
    var c = function (t) {
        var i = function (e) {
          return t[e]
        }, e = "(?:" + Object.keys(t).join("|") + ")", n = RegExp(e), s = RegExp(e, "g");
        return function (e) {
      ...
      h = c({"&amp;": "&", "&lt;": "<", "&gt;": ">", "&quot;": '"', "&#x27;": "'", "&#x60;": "`"}),
      p = function (e, t) {
        s.useDefault || (T.valHooks.select.set = s._set, s.useDefault = !0), this.$element = T(e), this.$newElement = null, this.$button = null, this.$menu = null, this.$lis = null, this.options = t, null === this.options.title && (this.options.title = this.$element.attr("title"));
    ...
    p.VERSION = "1.12.4", p.DEFAULTS = {
      ...
      constructor: p, init: function () {
        var t = this, e = this.$element.attr("id");
        this.$element.addClass("bs-select-hidden"), this.liObj = {}, this.multiple = this.$element.prop("multiple"), this.autofocus = this.$element.prop("autofocus"), this.$newElement = this.createView(), this.$element.after(this.$newElement).appendTo(this.$newElement), this.$button = this.$newElement.children("button"), this.$menu = this.$newElement.children(".dropdown-menu"), this.$menuInner = this.$menu.children(".inner"), this.$searchbox = this.$menu.find("input"), this.$element.removeClass("bs-select-hidden"), !0 === this.options.dropdownAlignRight && this.$menu.addClass("dropdown-menu-right"), void 0 !== e && (this.$button.attr("data-id", e), T('label[for="' + e + '"]').click(function (e) {
        ...
        var e = this.multiple || this.options.showTick ? " show-tick" : "",
          ...
          s = this.options.liveSearch ? '<div class="bs-searchbox"><input type="text" class="form-control" autocomplete="off"' + (null === this.options.liveSearchPlaceholder ? "" : ' placeholder="' + k(this.options.liveSearchPlaceholder) + '"') + ' role="textbox" aria-label="Search"></div>' : "",
          ...
          r = '<div class="btn-group bootstrap-select' + e + t + '"><button type="button" class="' + this.options.styleBase + ' dropdown-toggle" data-toggle="dropdown"' + i + ' role="button"><span class="filter-option pull-left"></span>&nbsp;<span class="bs-caret">' + this.options.template.caret + '</span></button><div class="dropdown-menu" role="combobox">' + n + s + o + '<ul class="dropdown-menu inner" role="listbox" aria-expanded="false"></ul>' + a + "</div></div>";
        return T(r)
      }, createView: function () {
        ...
        var $ = this, w = [], x = 0, e = document.createElement("option"), y = -1, C = function (e, t, i, n) {
          return "<li" + (void 0 !== i && "" !== i ? ' class="' + i + '"' : "") + (null != t ? ' data-original-index="' + t + '"' : "") + (null != n ? 'data-optgroup="' + n + '"' : "") + ">" + e + "</li>"
        }, S = function (e, t, i, n) {
          return '<a tabindex="0"' + (void 0 !== t ? ' class="' + t + '"' : "") + (i ? ' style="' + i + '"' : "") + ($.options.liveSearchNormalize ? ' data-normalized-text="' + a(k(T(e).html())) + '"' : "") + (void 0 !== n || null !== n ? ' data-tokens="' + n + '"' : "") + ' role="option">' + e + '<span class="' + $.options.iconBase + " " + $.options.tickIcon + ' check-mark"></span></a>'
        };
        if (this.options.title && !this.multiple && (y--, !this.$element.find(".bs-title-option").length)) {
          var t = this.$element[0];
          e.className = "bs-title-option", e.innerHTML = this.options.title, e.value = "", t.insertBefore(e, t.firstChild), void 0 === T(t.options[t.selectedIndex]).attr("selected") && void 0 === this.$element.data("selected") && (e.selected = !0)
        }
        var E = this.$element.find("option");
        return E.each(function (e) {
          var t = T(this);
          if (y++, !t.hasClass("bs-title-option")) {
            var i, n = this.className || "", s = k(this.style.cssText),
              o = t.data("content") ? t.data("content") : t.html(), a = t.data("tokens") ? t.data("tokens") : null,
              ...
              d = t.parent(), c = "OPTGROUP" === d[0].tagName, h = c && d[0].disabled, p = this.disabled || h;
            ...
            if (t.data("content") || (o = l + '<span class="text">' + o + r + "</span>"), c && !0 !== t.data("divider")) {
              ...
              if (0 === t.index()) {
                ...
                m = (d.data("icon") ? '<span class="' + $.options.iconBase + " " + d.data("icon") + '"></span> ' : "") + '<span class="text">' + k(m) + g + "</span>", 0 !== e && 0 < w.length && (y++, w.push(C("", null, "divider", x + "div"))), y++, w.push(C(m, null, "dropdown-header" + f, x))
              }
              if ($.options.hideDisabled && p) return void y--;
              w.push(C(S(o, "opt " + n + f, s, a), e, "", x))
            } else if (!0 === t.data("divider")) w.push(C("", e, "divider")); else if (!0 === t.data("hidden")) i = t.data("prevHiddenIndex"), t.next().data("prevHiddenIndex", void 0 !== i ? i : e), w.push(C(S(o, n, s, a), e, "hidden is-hidden")); else {
        ...
        }), this.multiple || 0 !== this.$element.find("option:selected").length || this.options.title || this.$element.find("option").eq(0).prop("selected", !0).attr("selected", "selected"), w.join("")
      }, findLis: function () {
        return null == this.$lis && (this.$lis = this.$menu.find("li")), this.$lis
      }, render: function (e) {
        var t, n = this, i = this.$element.find("option");
        !1 !== e && i.each(function (e) {
        ...
        var s = i.map(function () {
          if (this.selected) {
            ...
            return e = n.options.showSubtext && t.data("subtext") && !n.multiple ? ' <small class="text-muted">' + t.data("subtext") + "</small>" : "", void 0 !== t.attr("title") ? t.attr("title") : t.data("content") && n.options.showContent ? t.data("content").toString() : i + t.html() + e
          }
        ...
        null == this.options.title && (this.options.title = this.$element.attr("title")), "static" == this.options.selectedTextFormat && (o = this.options.title), o || (o = void 0 !== this.options.title ? this.options.title : this.options.noneSelectedText), this.$button.attr("title", h(T.trim(o.replace(/<[^>]*>?/g, "")))), this.$button.children(".filter-option").html(o), this.$element.trigger("rendered.bs.select")
        ...
        if (e || !1 !== this.options.size && !this.sizeInfo) {
          var t = document.createElement("div"), i = document.createElement("div"), n = document.createElement("ul"),
            s = document.createElement("li"), o = document.createElement("li"), a = document.createElement("a"),
          ...
          if (r.className = "text", t.className = this.$menu[0].parentNode.className + " open", i.className = "dropdown-menu", n.className = "dropdown-menu inner", s.className = "divider", r.appendChild(document.createTextNode("Inner text")), a.appendChild(r), o.appendChild(a), n.appendChild(o), n.appendChild(s), l && i.appendChild(l), d) {
          ...
          var u = a.offsetHeight, f = l ? l.offsetHeight : 0, m = d ? d.offsetHeight : 0, g = c ? c.offsetHeight : 0,
            v = h ? h.offsetHeight : 0, b = T(s).outerHeight(!0),
            $ = "function" == typeof getComputedStyle && getComputedStyle(i), w = $ ? null : T(i), x = {
              vert: parseInt($ ? $.paddingTop : w.css("paddingTop")) + parseInt($ ? $.paddingBottom : w.css("paddingBottom")) + parseInt($ ? $.borderTopWidth : w.css("borderTopWidth")) + parseInt($ ? $.borderBottomWidth : w.css("borderBottomWidth")),
              horiz: parseInt($ ? $.paddingLeft : w.css("paddingLeft")) + parseInt($ ? $.paddingRight : w.css("paddingRight")) + parseInt($ ? $.borderLeftWidth : w.css("borderLeftWidth")) + parseInt($ ? $.borderRightWidth : w.css("borderRightWidth"))
            }, y = {
        ...
        if (this.findLis(), this.liHeight(), this.options.header && this.$menu.css("padding-top", 0), !1 !== this.options.size) {
          var o, a, r, l, d, c, h, p, u = this, f = this.$menu, m = this.$menuInner, s = T(window),
            g = this.$newElement[0].offsetHeight, v = this.$newElement[0].offsetWidth, b = this.sizeInfo.liHeight,
            $ = this.sizeInfo.headerHeight, w = this.sizeInfo.searchHeight, x = this.sizeInfo.actionsHeight,
            y = this.sizeInfo.doneButtonHeight, e = this.sizeInfo.dividerHeight, C = this.sizeInfo.menuPadding,
            S = this.sizeInfo.menuExtras, t = this.options.hideDisabled ? ".disabled" : "", E = function () {
              var e, t = u.$newElement.offset(), i = T(u.options.container);
              u.options.container && !i.is("body") ? ((e = i.offset()).top += parseInt(i.css("borderTopWidth")), e.left += parseInt(i.css("borderLeftWidth"))) : e = {
                top: 0,
                left: 0
              };
          ...
          if (E(), "auto" === this.options.size) {
            var i = function () {
              ...
              E(), o = c - S.vert, a = p - S.horiz, l = u.options.container ? (f.data("height") || f.data("height", f.height()), r = f.data("height"), f.data("width") || f.data("width", f.width()), f.data("width")) : (r = f.height(), f.width()), u.options.dropupAuto && u.$newElement.toggleClass("dropup", c < d && o - S.vert < r), u.$newElement.hasClass("dropup") && (o = d - S.vert), "auto" === u.options.dropdownAlignRight && f.toggleClass("dropdown-menu-right", p < h && a - S.horiz < l - v), e = 3 < n.length + s.length ? 3 * b + S.vert - 2 : 0, f.css({
                "max-height": o + "px",
                overflow: "hidden",
                "min-height": e + $ + w + x + y + "px"
              }), m.css({
                "max-height": o - $ - w - x - y - C.vert + "px",
                "overflow-y": "auto",
                "min-height": Math.max(e - C.vert, 0) + "px"
              })
            };
            ...
            o = b * this.options.size + k * e + C.vert, r = u.options.container ? (f.data("height") || f.data("height", f.height()), f.data("height")) : f.height(), u.options.dropupAuto && this.$newElement.toggleClass("dropup", c < d && o - S.vert < r), f.css({
              "max-height": o + $ + w + x + y + "px",
              overflow: "hidden",
              "min-height": ""
        ...
        if ("auto" === this.options.width) {
          ...
          var e = this.$menu.parent().clone().appendTo("body"),
            ...
            i = e.children(".dropdown-menu").outerWidth(), n = t.css("width", "auto").children("button").outerWidth();
        ...
        var t, i, n, s = this, o = T(this.options.container), a = function (e) {
        ...
        t.data("spaceSelect", !1), this.$button.on("keyup", function (e) {
          ...
          var t = T(this), i = t.parent().data("originalIndex"), n = w.$element.val(),
            s = w.$element.prop("selectedIndex"), o = !0;
          if (w.multiple && 1 !== w.options.maxOptions && e.stopPropagation(), e.preventDefault(), !w.isDisabled() && !t.parent().hasClass("disabled")) {
            var a = w.$element.find("option"), r = a.eq(i), l = r.prop("selected"), d = r.parent("optgroup"),
              c = w.options.maxOptions, h = d.data("maxOptions") || !1;
            if (w.multiple) {
              if (r.prop("selected", !l), w.setSelected(i, !l), t.blur(), !1 !== c || !1 !== h) {
                var p = c < a.filter(":selected").length, u = h < d.find("option:selected").length;
                if (c && p || h && u) if (c && 1 == c) a.prop("selected", !1), r.prop("selected", !0), w.$menuInner.find(".selected").removeClass("selected"), w.setSelected(i, !0); else if (h && 1 == h) {
                  ...
                  var m = "string" == typeof w.options.maxOptionsText ? [w.options.maxOptionsText, w.options.maxOptionsText] : w.options.maxOptionsText,
                    g = "function" == typeof m ? m(c, h) : m, v = g[0].replace("{n}", c), b = g[1].replace("{n}", h),
                    $ = T('<div class="notify"></div>');
                  g[2] && (v = v.replace("{var}", g[2][1 < c ? 0 : 1]), b = b.replace("{var}", g[2][1 < h ? 0 : 1])), r.prop("selected", !1), w.$menu.append($), c && p && ($.append(T("<div>" + v + "</div>")), o = !1, w.$element.trigger("maxReached.bs.select")), h && u && ($.append(T("<div>" + b + "</div>")), o = !1, w.$element.trigger("maxReachedGrp.bs.select")), setTimeout(function () {
                    w.setSelected(i, !1)
            ...
            !w.multiple || w.multiple && 1 === w.options.maxOptions ? w.$button.focus() : w.options.liveSearch && w.$searchbox.focus(), o && (n != w.$element.val() && w.multiple || s != w.$element.prop("selectedIndex") && !w.multiple) && (x = [i, r.prop("selected"), l], w.$element.triggerNative("change"))
          }
        ...
        this.$button.on("click.dropdown.data-api", function () {
          ...
          if (s.$lis.not(".is-hidden").removeClass("hidden"), s.$lis.filter(".active").removeClass("active"), o.remove(), s.$searchbox.val()) {
            var e, t = s.$lis.not(".is-hidden, .divider, .dropdown-header");
            if ((e = s.options.liveSearchNormalize ? t.not(":a" + s._searchStyle() + '("' + a(s.$searchbox.val()) + '")') : t.not(":" + s._searchStyle() + '("' + s.$searchbox.val() + '")')).length === t.length) o.html(s.options.noneResultsText.replace("{0}", '"' + k(s.$searchbox.val()) + '"')), s.$menuInner.append(o), s.$lis.addClass("hidden"); else {
              e.addClass("hidden");
              var i, n = s.$lis.not(".hidden");
              n.each(function (e) {
                var t = T(this);
                t.hasClass("divider") ? void 0 === i ? t.addClass("hidden") : (i && i.addClass("hidden"), i = t) : t.hasClass("dropdown-header") && n.eq(e + 1).data("optgroup") !== t.data("optgroup") ? t.addClass("hidden") : i = null
              }), i && i.addClass("hidden"), t.not(".hidden").first().addClass("active"), s.$menuInner.scrollTop(0)
            }
          }
        })
        ...
        if (this.multiple) {
          ...
          var t = this.$element.find("option"), i = this.$lis.not(".divider, .dropdown-header, .disabled, .hidden"),
            n = i.length, s = [];
          if (e) {
        ...
        var e, i, n, s, o = T(this), a = (o.is("input") ? o.parent().parent() : o.parent()).data("this"),
        ...
        if (!(s = a.$newElement.hasClass("open")) && (48 <= t.keyCode && t.keyCode <= 57 || 96 <= t.keyCode && t.keyCode <= 105 || 65 <= t.keyCode && t.keyCode <= 90)) return a.options.container ? a.$button.trigger("click") : (a.setSize(), a.$menu.parent().addClass("open"), s = !0), void a.$searchbox.focus();
        if (a.options.liveSearch && /(^9$|27)/.test(t.keyCode.toString(10)) && s && (t.preventDefault(), t.stopPropagation(), a.$menuInner.click(), a.$button.focus()), /(38|40)/.test(t.keyCode.toString(10))) {
          ...
          i = a.options.liveSearch ? e.index(e.filter(".active")) : e.index(e.find("a").filter(":focus").parent()), n = a.$menuInner.data("prevIndex"), 38 == t.keyCode ? (!a.options.liveSearch && i != n || -1 == i || i--, i < 0 && (i += e.length)) : 40 == t.keyCode && ((a.options.liveSearch || i == n) && i++, i %= e.length), a.$menuInner.data("prevIndex", i), a.options.liveSearch ? (t.preventDefault(), o.hasClass("dropdown-toggle") || (e.removeClass("active").eq(i).addClass("active").children("a").focus(), o.focus())) : e.eq(i).children("a").focus()
        } else if (!o.is("input")) {
          var d, c = [];
          (e = a.$lis.filter(r)).each(function (e) {
            T.trim(T(this).children("a").text().toLowerCase()).substring(0, 1) == l[t.keyCode] && c.push(e)
          }), d = T(document).data("keycount"), d++, T(document).data("keycount", d), T.trim(T(":focus").text().toLowerCase()).substring(0, 1) != l[t.keyCode] ? (d = 1, T(document).data("keycount", d)) : d >= c.length && (T(document).data("keycount", 0), d > c.length && (d = 1)), e.eq(c[d - 1]).children("a").focus()
        }
        if ((/(13|32)/.test(t.keyCode.toString(10)) || /(^9$)/.test(t.keyCode.toString(10)) && a.options.selectOnTab) && s) {
          if (/(32)/.test(t.keyCode.toString(10)) || t.preventDefault(), a.options.liveSearch) /(32)/.test(t.keyCode.toString(10)) || (a.$menuInner.find(".active a").click(), o.focus()); else {
            var h = T(":focus");
            h.click(), h.focus(), t.preventDefault(), T(document).data("spaceSelect", !0)
          }
          T(document).data("keycount", 0)
        }
        (/(^9$|27)/.test(t.keyCode.toString(10)) && s && (a.multiple || a.options.liveSearch) || /(27)/.test(t.keyCode.toString(10)) && !s) && (a.$menu.parent().removeClass("open"), a.options.container && a.$newElement.removeClass("open"), a.$button.focus())
      }, mobile: function () {
    ...
    T.fn.selectpicker = u, T.fn.selectpicker.Constructor = p, T.fn.selectpicker.noConflict = function () {
      return T.fn.selectpicker = f, this
    }, T(document).data("keycount", 0).on("keydown.bs.select", '.bootstrap-select [data-toggle=dropdown], .bootstrap-select [role="listbox"], .bs-searchbox input', p.prototype.keydown).on("focusin.modal", '.bootstrap-select [data-toggle=dropdown], .bootstrap-select [role="listbox"], .bs-searchbox input', function (e) {
      e.stopPropagation()
  ...
  T.fn.extend({
    slimScroll: function (E) {
      ...
      return this.each(function () {
        var n, e, s, i, o, a, r, l, d = "<div></div>", c = 30, h = !1, p = T(this);
        if (p.parent().hasClass(k.wrapperClass)) {
          ...
          if (b = p.closest("." + k.barClass), v = p.closest("." + k.railClass), y(), T.isPlainObject(E)) {
            ...
            if ("scrollTo" in E) u = parseInt(k.scrollTo); else if ("scrollBy" in E) u += parseInt(k.scrollBy); else if ("destroy" in E) return b.remove(), v.remove(), void p.unwrap();
            x(u, !1, !0)
          }
        } else if (!(T.isPlainObject(E) && "destroy" in E)) {
          k.height = "auto" == k.height ? p.parent().height() : k.height;
          var m = T(d).addClass(k.wrapperClass).css({
            position: "relative",
            overflow: "hidden",
            width: k.width,
            height: k.height
          ...
          var g, v = T(d).addClass(k.railClass).css({
            width: k.size,
            height: "100%",
            position: "absolute",
            top: 0,
          ...
          v.css($), b.css($), p.wrap(m), p.parent().append(b), p.parent().append(v), k.railDraggable && b.bind("mousedown", function (e) {
            var i = T(document);
          ...
          }), y(), "bottom" === k.start ? (b.css({top: p.outerHeight() - b.outerHeight()}), x(0, !0)) : "top" !== k.start && (x(T(k.start).position().top, null, !0), k.alwaysVisible || b.hide()), g = this, window.addEventListener ? (g.addEventListener("DOMMouseScroll", w, !1), g.addEventListener("mousewheel", w, !1)) : document.attachEvent("onmousewheel", w)
        }
        ...
        function w(e) {
          if (n) {
            ...
            T(i).closest("." + k.wrapperClass).is(p.parent()) && x(t, !0), e.preventDefault && !h && e.preventDefault(), h || (e.returnValue = !1)
          }
        }

        function x(e, t, i) {
          h = !1;
          var n = e, s = p.outerHeight() - b.outerHeight();
          if (t && (n = parseInt(b.css("top")) + e * parseInt(k.wheelStep) / 100 * b.outerHeight(), n = Math.min(Math.max(n, 0), s), n = 0 < e ? Math.ceil(n) : Math.floor(n), b.css({top: n + "px"})), n = (r = parseInt(b.css("top")) / (p.outerHeight() - b.outerHeight())) * (p[0].scrollHeight - p.outerHeight()), i) {
  ...
  "use strict";
  var t = t || {}, n = document.querySelectorAll.bind(document), a = Object.prototype.toString,
  ...
  function h(e) {
    var t, i, n, s, o = {top: 0, left: 0}, a = e && e.ownerDocument;
    return t = a.documentElement, void 0 !== e.getBoundingClientRect && (o = e.getBoundingClientRect()), i = null !== (s = n = a) && s === s.window ? n : 9 === n.nodeType && n.defaultView, {
  ...
  var u = {
    duration: 750, delay: 200, show: function (e, t, i) {
      ...
      var r = "scale(" + t.clientWidth / 100 * 3 + ")", l = "translate(0,0)";
      i && (l = "translate(" + i.x + "px, " + i.y + "px)"), n.setAttribute("data-hold", Date.now()), n.setAttribute("data-x", a), n.setAttribute("data-y", o), n.setAttribute("data-scale", r), n.setAttribute("data-translate", l);
      var d = {top: o + "px", left: a + "px"};
      n.classList.add("waves-notransition"), n.setAttribute("style", p(d)), n.classList.remove("waves-notransition"), d["-webkit-transform"] = r + " " + l, d["-moz-transform"] = r + " " + l, d["-ms-transform"] = r + " " + l, d["-o-transform"] = r + " " + l, d.transform = r + " " + l, d.opacity = "1";
    ...
    input: function (e) {
      ...
      if ("i" !== t.tagName.toLowerCase() || !t.classList.contains("waves-effect")) {
        ...
        var n = window.getComputedStyle(e, null), s = n.color, o = n.backgroundColor;
  ...
  function o(e, t, i) {
    if (i) {
      ...
      setTimeout(function () {
        ...
        i.setAttribute("style", p(e)), setTimeout(function () {
          try {
            t.removeChild(i)
          } catch (e) {
            return !1
  ...
  return t.init = function (e) {
    var t = document.body;
    "duration" in (e = e || {}) && (u.duration = e.duration), "delay" in e && (u.delay = e.delay), r && (t.addEventListener("touchstart", i, !1), t.addEventListener("touchcancel", d.registerEvent, !1), t.addEventListener("touchend", d.registerEvent, !1)), t.addEventListener("mousedown", i, !1)
  }, t.attach = function (e, t) {
    var i, n;
    e = c(e), "[object Array]" === a.call(t) && (t = t.join(" ")), t = t ? " " + t : "";
    for (var s = 0, o = e.length; s < o; s++) n = (i = e[s]).tagName.toLowerCase(), -1 !== ["input", "img"].indexOf(n) && (l[n](i), i = i.parentElement), -1 === i.className.indexOf("waves-effect") && (i.className += " waves-effect" + t)
  }, t.ripple = function (e, t) {
    var i = (e = c(e)).length;
    if ((t = t || {}).wait = t.wait || 0, t.position = t.position || null, i) for (var n, s, o, a = {}, r = 0, l = {
      type: "mousedown",
      button: 1
    }, d = function (e, t) {
      return function () {
    ...
    }; r < i; r++) if (n = e[r], s = t.position || {
      x: n.clientWidth / 2,
      y: n.clientHeight / 2
    }, o = h(n), a.x = o.left + s.x, a.y = o.top + s.y, l.pageX = a.x, l.pageY = a.y, u.show(l, n), 0 <= t.wait && null !== t.wait) {
...
$.AdminAero = {}, $.AdminAero.options = {
  ...
  activate: function () {
    ...
    $(window).on("click", function (e) {
      var a = $(e.target);
      "i" === e.target.nodeName.toLowerCase() && (a = $(e.target).parent()), !a.hasClass("bars") && r.isOpen() && 0 === a.parents("#leftsidebar").length && (a.hasClass("js-right-sidebar2") || i.fadeOut(), t.removeClass("overlay-open"))
    }), $.each($(".menu-toggled.toggled"), function (e, a) {
      $(a).next().slideToggle(0)
    }), $.each($(".menu .list li.active"), function (e, a) {
      var r = $(a).find("a:eq(0)");
      r.addClass("toggled"), r.next().show()
    }), $(".menu-toggled").on("click", function (e) {
      var a = $(this), r = a.next();
      if ($(a.parents("ul")[0]).hasClass("list")) {
        var t = $(e.target).hasClass("menu-toggle") ? e.target : $(e.target).parents(".menu-toggle");
        $.each($(".menu-toggled.toggled").not(t).next(), function (e, a) {
